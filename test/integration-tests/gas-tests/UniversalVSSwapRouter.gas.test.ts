import { encodeSqrtRatioX96, FeeAmount, Pool, TickMath } from '@offsetcarbon/v3-sdk'
import { Pair, Route as V2RouteSDK } from '@offsetcarbon/v2-sdk'
import { Route as V3RouteSDK } from '@offsetcarbon/v3-sdk'
import { encodePath, expandTo18Decimals } from '../shared/swapRouter02Helpers'
import { BigNumber } from 'ethers'
import { SwapRouter } from '@offsetcarbon/router-sdk'
import {
...
import { CurrencyAmount, Percent, Token, TradeType } from '@offsetcarbon/sdk-core'
import snapshotGasCost from '@uniswap/snapshot-gas-cost'
import { IRoute, Trade } from '@offsetcarbon/router-sdk'
const { ethers } = hre
